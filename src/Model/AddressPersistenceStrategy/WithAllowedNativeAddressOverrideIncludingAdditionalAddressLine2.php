 ...
 * and if the "additionalAddressLine2" field is enabled in Shopware, but not the "additionalAddressLine1" field.
 */
final class WithAllowedNativeAddressOverrideIncludingAdditionalAddressLine2 implements AddressPersistenceStrategy
{
    ...
    public function buildAddressExtensionWithAddressUpsertPayload(
        ...
        $addressExtensionPayload['address'] = [
            'id' => $addressId,
            'street' => $fullStreet,
            'additionalAddressLine2' => $additionalInfo
        ];
    ...
    {
        return $addressEntity->getAdditionalAddressLine2() ?? '';
    }
    ...
    public function isAddressExtensionWithAddressPersistenceRequired(
        ...
        if ($addressEntity->getAdditionalAddressLine2() !== $additionalInfo) {
            return true;
        }
    ...
    public function updateAddress(
        ...
        if (is_string($additionalInfo) === true) {
            $addressEntity->setAdditionalAddressLine2($additionalInfo);
        }
    ...
    public function updateAddressData(
        ...
        $addressData['additionalAddressLine2'] = $additionalInfo;
